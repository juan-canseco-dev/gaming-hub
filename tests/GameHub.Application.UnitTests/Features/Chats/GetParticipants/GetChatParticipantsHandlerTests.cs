...
using GameHub.Application.Features.Chats.GetParticipants;
...
namespace GameHub.Application.UnitTests.Features.Chats.GetParticipants;
public sealed class GetChatParticipantsHandlerTests
{
    ...
    [Fact]
    public async Task Handle_Should_Return_First_Page_Ordered_With_After_And_Before_Cursors()
    {
        // Arrange
        var chatId = Guid.NewGuid();
